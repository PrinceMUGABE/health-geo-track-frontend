...
function Data_Entry_Clerk_Layout() {
  ...
  const navLinks = [
    { id: 1, name: "Dashboard", path: "/data_entry_clerk", icon: <MdDashboard /> },
    { id: 2, name: "Health Facilities", path: "/data_entry_clerk/facilities", icon: <GiHealthNormal /> },
    { id: 3, name: "Population Data", path: "/data_entry_clerk/populations", icon: <AiFillDatabase /> },
    { id: 4, name: "Disease Incidence", path: "/data_entry_clerk/diseases", icon: <FiActivity /> },
    { id: 5, name: "Health Accessibilities", path: "/data_entry_clerk/accessibilities", icon: <BiAccessibility /> },
    { id: 6, name: "Resource Allocations", path: "/data_entry_clerk/allocations", icon: <GiHealthNormal /> },
    { id: 7, name: "Profile", path: `/data_entry_clerk/profile/${userId}`, icon: <FaUserCircle /> },
  ];
...
export default Data_Entry_Clerk_Layout;
