...
function Data_Entry_Clerk_Home() {
    ...
    <div className="ml-4 p-6 space-y-6 justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <SummaryCard
          ...
          icon={Building2}
          bgColor="bg-gradient-to-r from-blue-400 to-green-600"
        />
        <SummaryCard
          title="Total Incidents"
          value={incidents.length}
          icon={Activity}
          bgColor="bg-gradient-to-r from-sky-500 to-sky-900"
        />
        <SummaryCard
          title="Resource Allocations"
          value={allocations.length}
          icon={PieChart}
          bgColor="bg-gradient-to-r from-sky-500 to-purple-600"
        />
      </div>
...
export default Data_Entry_Clerk_Home;