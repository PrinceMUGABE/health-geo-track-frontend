...
import minaloc from '../../assets/pictures/system/rwanda-logo.png';
import minisante from '../../assets/pictures/system/logo.jpg';
...
const Partners = () => {
  const partners = [
    { name: "Minaloc", url: "https://www.minaloc.gov.rw/", image: minaloc },
    { name: "Ministry of Health", url: "http://www.moh.gov.rw/", image: minisante },
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    <div 
                      ...
                      className="flex items-center space-x-2 text-blue-400 hover:text-blue-800 cursor-pointer group/link"
                    >
